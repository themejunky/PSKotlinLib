...
open class CustomSpinnerAdapterItem(context: Context, nValues: List<Item>, nAlignment: String, nBold:Boolean=false) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        if (convertView == null) {
            ...
            vh = ListRowHolderItem(view)
            view.tag = vh
        } else {
            view = convertView
            vh = view.tag as ListRowHolderItem
        }
...
private class ListRowHolderItem(row: View?) {
